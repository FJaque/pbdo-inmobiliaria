...
public class PropietariosDAOTest {
	 ...
	 *
	 */
	private PropietariosDAO dataStore;

	/**
	 * Instantiates a new PropietariosDAOTest.
	 *
	 */
	public PropietariosDAOTest() {
	}

	/**
	 * Method to test Propietarios domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Propietarios() {
		Propietarios instance = new Propietarios();
	 ...
	 */
	@Autowired
	public void setDataStore(PropietariosDAO dataStore) {
