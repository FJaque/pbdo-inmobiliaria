...
<html>
<head>
<title>Edit <fmt:message key="propietarios.title"/> <fmt:message key="propiedades.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePropietariosPropiedadeses" method="POST" modelAttribute="propiedades">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="propietarios_numpropietario" value="${propietarios_numpropietario}" >
