...
<html>
<head>
<title>Edit <fmt:message key="propietarios.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePropietarios" method="POST" modelAttribute="propietarios">
