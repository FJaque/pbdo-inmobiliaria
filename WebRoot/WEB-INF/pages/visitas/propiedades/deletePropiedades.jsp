...
<html>
<head>
<title>View <fmt:message key="visitas.title"/> <fmt:message key="propiedades.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteVisitasPropiedades?visitas_numcliente=${visitas_numcliente}&visitas_fecha=${visitas_fecha}&visitas_numpropiedad=${visitas_numpropiedad}&related_propiedades_numpropiedad=${propiedades.numpropiedad}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
