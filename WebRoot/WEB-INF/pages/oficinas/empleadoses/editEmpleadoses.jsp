...
<html>
<head>
<title>Edit <fmt:message key="oficinas.title"/> <fmt:message key="empleados.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveOficinasEmpleadoses" method="POST" modelAttribute="empleados">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="oficinas_numoficina" value="${oficinas_numoficina}" >
