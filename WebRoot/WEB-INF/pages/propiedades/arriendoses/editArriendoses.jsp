...
<html>
<head>
<title>Edit <fmt:message key="propiedades.title"/> <fmt:message key="arriendos.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePropiedadesArriendoses" method="POST" modelAttribute="arriendos">
