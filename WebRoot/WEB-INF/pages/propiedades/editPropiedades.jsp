...
<html>
<head>
<title>Edit <fmt:message key="propiedades.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePropiedades" method="POST" modelAttribute="propiedades">
