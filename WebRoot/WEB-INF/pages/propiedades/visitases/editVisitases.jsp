...
<html>
<head>
<title>Edit <fmt:message key="propiedades.title"/> <fmt:message key="visitas.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePropiedadesVisitases" method="POST" modelAttribute="visitas">
