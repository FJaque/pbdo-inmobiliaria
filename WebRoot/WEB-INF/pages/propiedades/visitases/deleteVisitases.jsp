...
<html>
<head>
<title>View <fmt:message key="propiedades.title"/> <fmt:message key="visitas.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deletePropiedadesVisitases?propiedades_numpropiedad=${propiedades_numpropiedad}&related_visitases_numcliente=${visitas.numcliente}&related_visitases_fecha=${visitas.fecha}&related_visitases_numpropiedad=${visitas.numpropiedad}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
