...
<html>
<head>
<title>View <fmt:message key="propiedades.title"/> <fmt:message key="empleados.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deletePropiedadesEmpleados?propiedades_numpropiedad=${propiedades_numpropiedad}&related_empleados_numempleado=${empleados.numempleado}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
