...
<html>
<head>
<title>Edit <fmt:message key="arriendos.title"/> <fmt:message key="propiedades.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveArriendosPropiedades" method="POST" modelAttribute="propiedades">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="arriendos_numarriendo" value="${arriendos_numarriendo}" >
