...
<html>
<head>
<title>Edit <fmt:message key="arriendos.title"/> <fmt:message key="clientes.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveArriendosClientes" method="POST" modelAttribute="clientes">
