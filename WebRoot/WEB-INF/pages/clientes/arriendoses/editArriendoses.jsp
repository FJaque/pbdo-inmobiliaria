...
<html>
<head>
<title>Edit <fmt:message key="clientes.title"/> <fmt:message key="arriendos.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveClientesArriendoses" method="POST" modelAttribute="arriendos">
