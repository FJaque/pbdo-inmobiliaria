...
<html>
<head>
<title>Edit <fmt:message key="empleados.title"/> <fmt:message key="propiedades.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveEmpleadosPropiedadeses" method="POST" modelAttribute="propiedades">
